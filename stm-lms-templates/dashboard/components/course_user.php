				...
				<div class="section" v-for="(section, index) in data.sections">
					...
					<div class="section_items">
						<div class="section_item" v-for="item in data.materials.filter(item => item.section_id === section.id)"
							...
							<div class="section_item__completed stm-display-flex">
								<div v-if="item.type==='assignment' || item.type==='quiz'">
									<div class="progress-wrapper section_grade" v-if="item.quiz_info.progress">
										<div class="progress-label"><span v-html="item.quiz_info.progress"></span>%</div>
									</div>
									<div v-else>
										<div class="progress-wrapper section_grade">
